...
class LearningPredictorEnv(gymnasium.Env):
    ...
    def __init__(self,  data_file_path, config):
        ...
        self.max_sequence_length = 17 # 6 for studied_credits group + 11 for assessment scores
        self.config = config
    ...
    def init_demographics(self):
        ...
        demographics = user_demographics.loc[:, user_demographics.columns.str.startswith('group_studied_credits_')].iloc[0].astype(int).tolist()
        return demographics
